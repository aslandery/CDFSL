...
def mix_rbf_mmd2(X, Y, sigmas=(1,), wts=None, biased=True, m=0, n=0):
    K_XX, K_XY, K_YY, d = _mix_rbf_kernel(X, Y, sigmas, wts)
    return _mmd2(K_XX, K_XY, K_YY, const_diagonal=d, biased=biased, m=m, n=n)
...
def _mmd2(K_XX, K_XY, K_YY, const_diagonal=False, biased=False, m=0, n=0):
    if m ==0 or  n==0:
        m = K_XX.get_shape()[0]
        n = K_XY.get_shape()[0]
